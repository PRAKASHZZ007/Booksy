...
From one store in Mumbai to 92 locations across 32 cities, we’ve grown with our readers.  
...
<p className="banner-text">
As India's favorite destination for book lovers, we bring you a thoughtfully curated collection across genres.  
